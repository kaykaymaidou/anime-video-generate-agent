// ============================================
// anime-video-generate-agent（前端）全局类型
// ============================================

export type { CostTransaction } from "./Cost";
...
export interface Shot {
  ...
  /** 同镜多次生成的成片 URL（含当前定稿）；导出时间线与快照会带上 */
  videoTakeUrls?: string[];
  referenceImage?: string | null;
  /** Seedance first_frame：开场构图锚点 */
  firstFrame?: string | null;
  /** Seedance last_frame：衔接下一镜 */
